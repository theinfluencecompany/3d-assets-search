/* eslint-disable */
// Generated by Wrangler by running `wrangler types /Users/xupengtong/fried-marketing/mcp-servers/3d-assets-search/src/worker-configuration.d.ts --config /Users/xupengtong/fried-marketing/mcp-servers/3d-assets-search/wrangler.jsonc` (hash: 581ea9c8d4de8d494df5035d5915b191)
// Runtime types generated with workerd@1.20260305.0 2026-03-01 nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./worker");
    durableNamespaces: "AssetSearchMcp";
  }
  interface Env {
    ASSETS_BUCKET: R2Bucket;
    ASSETS_BASE_URL: "https://assets.fried.gg";
    CLOUDFLARE_ACCOUNT_ID: string;
    R2_BUCKET: string;
    R2_ACCESS_KEY_ID: string;
    R2_SECRET_ACCESS_KEY: string;
    MCP_OBJECT: DurableObjectNamespace<import("./worker").AssetSearchMcp>;
  }
}
